...
exec.Command("latte", "install", "conmon")
	fmt.Println("Instalando dependencia: crun")
exec.Command("latte", "install", "crun")
	fmt.Println("Instalando dependencia: fuse-overlayfs")
exec.Command("latte", "install", "fuse-overlayfs")
...
exec.Command("latte", "install", "passt")
	fmt.Println("Instalando dependencia: slirp4netns")
exec.Command("latte", "install", "slirp4netns")
