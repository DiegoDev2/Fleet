...
exec.Command("latte", "install", "cpio")
	fmt.Println("Instalando dependencia: gtk-vnc")
exec.Command("latte", "install", "gtk-vnc")
...
exec.Command("latte", "install", "libosinfo")
	fmt.Println("Instalando dependencia: libvirt-glib")
exec.Command("latte", "install", "libvirt-glib")
	fmt.Println("Instalando dependencia: libvirt-python")
exec.Command("latte", "install", "libvirt-python")
...
exec.Command("latte", "install", "spice-gtk")
