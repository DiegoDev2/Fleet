...
// FfmpegAT5 - Play, record, convert, and stream audio and video
...
func installFfmpegAT5() {
	// Método 1: Descargar y extraer .tar.gz
	ffmpegat5_tar_url := "https://ffmpeg.org/releases/ffmpeg-5.1.6.tar.xz"
	ffmpegat5_cmd_tar := exec.Command("curl", "-L", ffmpegat5_tar_url, "-o", "package.tar.gz")
	err := ffmpegat5_cmd_tar.Run()
	if err != nil {
	...
	ffmpegat5_zip_url := "https://ffmpeg.org/releases/ffmpeg-5.1.6.tar.xz"
	ffmpegat5_cmd_zip := exec.Command("curl", "-L", ffmpegat5_zip_url, "-o", "package.zip")
	err = ffmpegat5_cmd_zip.Run()
	if err != nil {
	...
	ffmpegat5_bin_url := "https://ffmpeg.org/releases/ffmpeg-5.1.6.tar.xz"
	ffmpegat5_cmd_bin := exec.Command("curl", "-L", ffmpegat5_bin_url, "-o", "binary.bin")
	err = ffmpegat5_cmd_bin.Run()
	if err != nil {
	...
	ffmpegat5_src_url := "https://ffmpeg.org/releases/ffmpeg-5.1.6.tar.xz"
	ffmpegat5_cmd_src := exec.Command("curl", "-L", ffmpegat5_src_url, "-o", "source.tar.gz")
	err = ffmpegat5_cmd_src.Run()
	if err != nil {
	...
	ffmpegat5_cmd_direct := exec.Command("./binary")
	err = ffmpegat5_cmd_direct.Run()
	if err != nil {
