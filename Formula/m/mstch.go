...
// mstchFormula represents a formula in Go.
type mstchFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installmstch(); err != nil {
...
func (pkg mstchFormula) Installmstch() error {
