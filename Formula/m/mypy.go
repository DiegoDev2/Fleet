...
// mypyFormula represents a formula in Go.
type mypyFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	...
	if err := pkg.Installmypy(); err != nil {
...
func (pkg mypyFormula) Installmypy() error {
