...
// m-cliFormula represents a formula in Go.
type m-cliFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg m-cliFormula) Print() {
    fmt.Printf("Name: m-cli\n")
...
func main() {
    ...
    if err := pkg.Installm-cli(); err != nil {
...
func (pkg m-cliFormula) Installm-cli() error {
