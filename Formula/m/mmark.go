...
// mmarkFormula represents a formula in Go.
type mmarkFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	...
	if err := pkg.Installmmark(); err != nil {
...
func (pkg mmarkFormula) Installmmark() error {
