...
// mleFormula represents a formula in Go.
type mleFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    pkg := mleFormula{
        ...
        Dependencies: []string{"uthash", "lua", "pcre2"},
    }
...
func (pkg mleFormula) Installmle() error {
