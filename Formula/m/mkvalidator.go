...
// mkvalidatorFormula represents a formula in Go.
type mkvalidatorFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg mkvalidatorFormula) Print() {
...
func main() {
    ...
    if err := pkg.Installmkvalidator(); err != nil {
...
func (pkg mkvalidatorFormula) Installmkvalidator() error {
