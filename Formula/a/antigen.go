...
// antigenFormula represents a formula in Go.
type antigenFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	...
	if err := pkg.Installantigen(); err != nil {
...
func (pkg antigenFormula) Installantigen() error {
