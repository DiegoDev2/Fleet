...
// apktoolFormula represents a formula in Go.
type apktoolFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installapktool(); err != nil {
...
func (pkg apktoolFormula) Installapktool() error {
