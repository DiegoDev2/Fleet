...
// abi-compliance-checkerFormula represents a formula in Go.
type abi-compliance-checkerFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg abi-compliance-checkerFormula) Print() {
...
", dep)
    ...
    if err := pkg.Installabi-compliance-checker(); err != nil {
...
func (pkg abi-compliance-checkerFormula) Installabi-compliance-checker() error {
