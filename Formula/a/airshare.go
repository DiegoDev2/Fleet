...
// airshareFormula represents a formula in Go.
type airshareFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func (pkg airshareFormula) Print() {
...
func main() {
	...
	if err := pkg.Installairshare(); err != nil {
...
func (pkg airshareFormula) Installairshare() error {
