...
// awscurlFormula represents a formula in Go.
type awscurlFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installawscurl(); err != nil {
...
func (pkg awscurlFormula) Installawscurl() error {
