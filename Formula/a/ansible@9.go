...
// ansible@9Formula represents a formula in Go.
type ansible@9Formula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg ansible@9Formula) Print() {
    fmt.Printf("Name: ansible@9\n")
...
", dep)
    ...
    if err := pkg.Installansible@9(); err != nil {
...
func (pkg ansible@9Formula) Installansible@9() error {
