...
// alassFormula represents a formula in Go.
type alassFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installalass(); err != nil {
...
func (pkg alassFormula) Installalass() error {
