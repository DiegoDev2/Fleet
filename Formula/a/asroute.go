...
// asrouteFormula represents a formula in Go.
type asrouteFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installasroute(); err != nil {
...
func (pkg asrouteFormula) Installasroute() error {
