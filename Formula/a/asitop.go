...
// asitopFormula represents a formula in Go.
type asitopFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installasitop(); err != nil {
...
func (pkg asitopFormula) Installasitop() error {
