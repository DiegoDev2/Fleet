...
// wikiFormula represents a formula in Go.
...
func main() {
    pkg := wikiFormula{
        Description:  "Fetch summaries from MediaWiki wikis, like Wikipedia",
    ...
    if err := pkg.Installwiki(); err != nil {
...
func (pkg wikiFormula) Installwiki() error {
