...
// webifyFormula represents a formula in Go.
type webifyFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installwebify(); err != nil {
...
func (pkg webifyFormula) Installwebify() error {
