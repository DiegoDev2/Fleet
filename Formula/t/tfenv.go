...
// tfenvFormula represents a formula in Go.
type tfenvFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installtfenv(); err != nil {
...
func (pkg tfenvFormula) Installtfenv() error {
