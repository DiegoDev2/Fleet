...
// theharvesterFormula represents a formula in Go.
type theharvesterFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg theharvesterFormula) Print() {
...
", dep)
    ...
    if err := pkg.Installtheharvester(); err != nil {
...
func (pkg theharvesterFormula) Installtheharvester() error {
