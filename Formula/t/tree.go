...
// treeFormula represents a formula in Go.
type treeFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installtree(); err != nil {
...
func (pkg treeFormula) Installtree() error {
