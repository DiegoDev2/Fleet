...
// telnetFormula represents a formula in Go.
type telnetFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installtelnet(); err != nil {
...
func (pkg telnetFormula) Installtelnet() error {
