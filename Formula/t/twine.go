...
// twineFormula represents a formula in Go.
type twineFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installtwine(); err != nil {
...
func (pkg twineFormula) Installtwine() error {
