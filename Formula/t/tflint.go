...
// tflintFormula represents a formula in Go.
type tflintFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installtflint(); err != nil {
...
func (pkg tflintFormula) Installtflint() error {
