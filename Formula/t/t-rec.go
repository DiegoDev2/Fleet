...
// t-recFormula represents a formula in Go.
type t-recFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg t-recFormula) Print() {
    fmt.Printf("Name: t-rec\n")
...
func main() {
    ...
    if err := pkg.Installt-rec(); err != nil {
...
func (pkg t-recFormula) Installt-rec() error {
