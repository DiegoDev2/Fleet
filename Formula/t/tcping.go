...
// tcpingFormula represents a formula in Go.
type tcpingFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installtcping(); err != nil {
...
func (pkg tcpingFormula) Installtcping() error {
