...
// trzszFormula represents a formula in Go.
type trzszFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installtrzsz(); err != nil {
...
func (pkg trzszFormula) Installtrzsz() error {
