...
// taktukFormula represents a formula in Go.
type taktukFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installtaktuk(); err != nil {
...
func (pkg taktukFormula) Installtaktuk() error {
