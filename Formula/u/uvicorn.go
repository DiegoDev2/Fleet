...
// uvicornFormula represents a formula in Go.
type uvicornFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installuvicorn(); err != nil {
...
func (pkg uvicornFormula) Installuvicorn() error {
