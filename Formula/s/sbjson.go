...
// sbjsonFormula represents a formula in Go.
type sbjsonFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installsbjson(); err != nil {
...
func (pkg sbjsonFormula) Installsbjson() error {
