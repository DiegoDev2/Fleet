...
// sternFormula represents a formula in Go.
type sternFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installstern(); err != nil {
...
func (pkg sternFormula) Installstern() error {
