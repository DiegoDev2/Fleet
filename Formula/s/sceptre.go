...
// sceptreFormula represents a formula in Go.
type sceptreFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installsceptre(); err != nil {
...
func (pkg sceptreFormula) Installsceptre() error {
