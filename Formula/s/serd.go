...
// serdFormula represents a formula in Go.
type serdFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installserd(); err != nil {
...
func (pkg serdFormula) Installserd() error {
