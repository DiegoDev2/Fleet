...
// srtpFormula represents a formula in Go.
type srtpFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installsrtp(); err != nil {
...
func (pkg srtpFormula) Installsrtp() error {
