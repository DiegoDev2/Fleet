...
// snappyFormula represents a formula in Go.
type snappyFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    pkg := snappyFormula{
        ...
        Dependencies: []string{"cmake", "pkg-config", "llvm"},
    }
...
", dep)
    ...
    if err := pkg.Installsnappy(); err != nil {
...
func (pkg snappyFormula) Installsnappy() error {
