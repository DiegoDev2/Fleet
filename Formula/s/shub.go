...
// shubFormula represents a formula in Go.
type shubFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installshub(); err != nil {
...
func (pkg shubFormula) Installshub() error {
