...
// slidesFormula represents a formula in Go.
type slidesFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installslides(); err != nil {
...
func (pkg slidesFormula) Installslides() error {
