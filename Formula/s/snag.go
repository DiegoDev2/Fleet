...
// snagFormula represents a formula in Go.
type snagFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installsnag(); err != nil {
...
func (pkg snagFormula) Installsnag() error {
