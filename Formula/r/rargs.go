...
// rargsFormula represents a formula in Go.
type rargsFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installrargs(); err != nil {
...
func (pkg rargsFormula) Installrargs() error {
