...
// redexFormula represents a formula in Go.
type redexFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    pkg := redexFormula{
        ...
        Dependencies: []string{"autoconf", "automake", "libevent", "libtool", "boost", "jsoncpp", "python@3.12"},
    }
    ...
    if err := pkg.Installredex(); err != nil {
...
func (pkg redexFormula) Installredex() error {
