...
// ratsFormula represents a formula in Go.
type ratsFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    pkg := ratsFormula{
        ...
        Sha256:       "225ac8dd692f21f8f13e072dba7bc2904cb11e08273d9917bde0ef1f42133b03",
        Dependencies: []string{},
    }
    ...
    if err := pkg.Installrats(); err != nil {
...
func (pkg ratsFormula) Installrats() error {
    cmd := exec.Command("curl", "-O", pkg.URL)
    if err := cmd.Run(); err != nil {
        return fmt.Errorf("failed to download: %v", err)
    }

    tarball := "rats-2.4.tgz"
