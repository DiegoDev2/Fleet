...
// rfcstripFormula represents a formula in Go.
type rfcstripFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg rfcstripFormula) Print() {
...
", dep)
    ...
    if err := pkg.Installrfcstrip(); err != nil {
...
func (pkg rfcstripFormula) Installrfcstrip() error {
