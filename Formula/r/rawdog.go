...
// rawdogFormula represents a formula in Go.
type rawdogFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg rawdogFormula) Print() {
    fmt.Printf("Name: rawdog\n")
...
func main() {
    pkg := rawdogFormula{
        Description:  "CLI tool to generate and run code with llms",
...
", dep)
    ...
    if err := pkg.Installrawdog(); err != nil {
...
func (pkg rawdogFormula) Installrawdog() error {
