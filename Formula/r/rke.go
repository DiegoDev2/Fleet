...
// rkeFormula represents a formula in Go.
type rkeFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    pkg := rkeFormula{
        ...
        Sha256:       "f4009a7ea36441b8e0cb062b5a3d2c32c558a61062b166ba60bad015aff0a050",
...
func (pkg rkeFormula) Installrke() error {
