...
// ravenFormula represents a formula in Go.
type ravenFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installraven(); err != nil {
...
func (pkg ravenFormula) Installraven() error {
