...
// replFormula represents a formula in Go.
type replFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installrepl(); err != nil {
...
func (pkg replFormula) Installrepl() error {
