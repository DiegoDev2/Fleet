...
// bottomFormula represents a formula in Go.
type bottomFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installbottom(); err != nil {
...
func (pkg bottomFormula) Installbottom() error {
