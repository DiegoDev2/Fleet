...
// blake3Formula represents a formula in Go.
type blake3Formula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installblake3(); err != nil {
...
func (pkg blake3Formula) Installblake3() error {
