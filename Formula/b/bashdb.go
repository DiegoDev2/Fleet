...
// bashdbFormula represents a formula in Go.
type bashdbFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	...
	if err := pkg.Installbashdb(); err != nil {
...
func (pkg bashdbFormula) Installbashdb() error {
