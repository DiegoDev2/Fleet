...
// blueutilFormula represents a formula in Go.
type blueutilFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg blueutilFormula) Print() {
...
func main() {
    ...
    if err := pkg.Installblueutil(); err != nil {
...
func (pkg blueutilFormula) Installblueutil() error {
