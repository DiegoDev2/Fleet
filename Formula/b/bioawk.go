...
// bioawkFormula represents a formula in Go.
type bioawkFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installbioawk(); err != nil {
...
func (pkg bioawkFormula) Installbioawk() error {
