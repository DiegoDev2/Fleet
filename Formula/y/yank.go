...
// yankFormula represents a formula in Go.
type yankFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installyank(); err != nil {
...
func (pkg yankFormula) Installyank() error {
