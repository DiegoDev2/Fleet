...
func installSecurefs() {
	...
	exec.Command("latte", "install", "tclap").Run()
	...
	exec.Command("latte", "install", "cryptopp").Run()
	fmt.Println("Instalando dependencia: fruit")
	exec.Command("latte", "install", "fruit").Run()
	...
	exec.Command("latte", "install", "uni-algo").Run()
