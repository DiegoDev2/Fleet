...
// cargo-bundleFormula represents a formula in Go.
type cargo-bundleFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg cargo-bundleFormula) Print() {
    fmt.Printf("Name: cargo-bundle\n")
...
func main() {
    ...
    if err := pkg.Installcargo-bundle(); err != nil {
...
func (pkg cargo-bundleFormula) Installcargo-bundle() error {
