...
// chiselFormula represents a formula in Go.
type chiselFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installchisel(); err != nil {
...
func (pkg chiselFormula) Installchisel() error {
