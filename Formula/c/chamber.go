...
// chamberFormula represents a formula in Go.
type chamberFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installchamber(); err != nil {
...
func (pkg chamberFormula) Installchamber() error {
