...
// csvprintfFormula represents a formula in Go.
type csvprintfFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func (pkg csvprintfFormula) Print() {
...
func main() {
	...
	if err := pkg.Installcsvprintf(); err != nil {
...
func (pkg csvprintfFormula) Installcsvprintf() error {
