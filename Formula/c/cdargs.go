...
// cdargsFormula represents a formula in Go.
type cdargsFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installcdargs(); err != nil {
...
func (pkg cdargsFormula) Installcdargs() error {
