...
// cmockeryFormula represents a formula in Go.
type cmockeryFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg cmockeryFormula) Print() {
...
func main() {
    ...
    if err := pkg.Installcmockery(); err != nil {
...
func (pkg cmockeryFormula) Installcmockery() error {
