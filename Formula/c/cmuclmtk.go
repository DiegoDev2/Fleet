...
// cmuclmtkFormula represents a formula in Go.
type cmuclmtkFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func (pkg cmuclmtkFormula) Print() {
...
func main() {
	...
	if err := pkg.Installcmuclmtk(); err != nil {
...
func (pkg cmuclmtkFormula) Installcmuclmtk() error {
