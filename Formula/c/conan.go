...
// conanFormula represents a formula in Go.
type conanFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installconan(); err != nil {
...
func (pkg conanFormula) Installconan() error {
