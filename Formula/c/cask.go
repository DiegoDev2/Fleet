...
// caskFormula represents a formula in Go.
type caskFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    pkg := caskFormula{
        ...
        Dependencies: []string{"coreutils", "emacs"},
    }
    ...
    if err := pkg.Installcask(); err != nil {
...
func (pkg caskFormula) Installcask() error {
