...
// crf++Formula represents a formula in Go.
type crf++Formula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg crf++Formula) Installcrf++() error {
