...
// cubelibFormula represents a formula in Go.
type cubelibFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installcubelib(); err != nil {
...
func (pkg cubelibFormula) Installcubelib() error {
