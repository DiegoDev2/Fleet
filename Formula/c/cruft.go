...
// cruftFormula represents a formula in Go.
type cruftFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installcruft(); err != nil {
...
func (pkg cruftFormula) Installcruft() error {
