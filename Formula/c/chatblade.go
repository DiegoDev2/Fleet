...
// chatbladeFormula represents a formula in Go.
type chatbladeFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg chatbladeFormula) Print() {
...
", dep)
    ...
    if err := pkg.Installchatblade(); err != nil {
...
func (pkg chatbladeFormula) Installchatblade() error {
