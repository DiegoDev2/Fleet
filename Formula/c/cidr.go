...
// cidrFormula represents a formula in Go.
type cidrFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	pkg := cidrFormula{
		...
		Sha256:       "bebb8b71e94081655b343967ec6d56e78daeee550a60dd75bbcbc50d45a3f9ee",
	...
	if err := pkg.Installcidr(); err != nil {
...
func (pkg cidrFormula) Installcidr() error {
