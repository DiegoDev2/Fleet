...
// cascadiaFormula represents a formula in Go.
type cascadiaFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func (pkg cascadiaFormula) Print() {
...
func main() {
	...
	if err := pkg.Installcascadia(); err != nil {
...
func (pkg cascadiaFormula) Installcascadia() error {
