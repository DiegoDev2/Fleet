...
// caracalFormula represents a formula in Go.
type caracalFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	pkg := caracalFormula{
		Description:  "Static analyzer for Starknet smart contracts",
	...
	if err := pkg.Installcaracal(); err != nil {
...
func (pkg caracalFormula) Installcaracal() error {
