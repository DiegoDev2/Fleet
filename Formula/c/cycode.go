...
// cycodeFormula represents a formula in Go.
type cycodeFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installcycode(); err != nil {
...
func (pkg cycodeFormula) Installcycode() error {
