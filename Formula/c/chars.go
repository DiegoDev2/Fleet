...
// charsFormula represents a formula in Go.
type charsFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	pkg := charsFormula{
		...
		Sha256:       "ef3b72700c113acb7f3fbf7b977d2e2b16906384325d0f606ada0929c2eab9a9",
	...
	if err := pkg.Installchars(); err != nil {
...
func (pkg charsFormula) Installchars() error {
