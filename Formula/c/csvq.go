...
// csvqFormula represents a formula in Go.
type csvqFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	...
	if err := pkg.Installcsvq(); err != nil {
...
func (pkg csvqFormula) Installcsvq() error {
