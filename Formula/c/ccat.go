...
// ccatFormula represents a formula in Go.
type ccatFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installccat(); err != nil {
...
func (pkg ccatFormula) Installccat() error {
