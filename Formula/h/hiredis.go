...
// hiredisFormula represents a formula in Go.
type hiredisFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installhiredis(); err != nil {
...
func (pkg hiredisFormula) Installhiredis() error {
