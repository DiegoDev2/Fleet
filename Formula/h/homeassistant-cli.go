...
// homeassistant-cliFormula represents a formula in Go.
type homeassistant-cliFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg homeassistant-cliFormula) Print() {
    fmt.Printf("Name: homeassistant-cli\n")
...
func main() {
    ...
    if err := pkg.Installhomeassistant-cli(); err != nil {
...
func (pkg homeassistant-cliFormula) Installhomeassistant-cli() error {
