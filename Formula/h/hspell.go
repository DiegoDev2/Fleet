...
// hspellFormula represents a formula in Go.
type hspellFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installhspell(); err != nil {
...
func (pkg hspellFormula) Installhspell() error {
