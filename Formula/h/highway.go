...
// highwayFormula represents a formula in Go.
type highwayFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installhighway(); err != nil {
...
func (pkg highwayFormula) Installhighway() error {
