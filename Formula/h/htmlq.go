...
// htmlqFormula represents a formula in Go.
type htmlqFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installhtmlq(); err != nil {
...
func (pkg htmlqFormula) Installhtmlq() error {
