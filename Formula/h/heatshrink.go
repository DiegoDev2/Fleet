...
// heatshrinkFormula represents a formula in Go.
type heatshrinkFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func (pkg heatshrinkFormula) Print() {
...
func main() {
	...
	if err := pkg.Installheatshrink(); err != nil {
...
func (pkg heatshrinkFormula) Installheatshrink() error {
