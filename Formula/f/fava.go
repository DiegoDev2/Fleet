...
// favaFormula represents a formula in Go.
type favaFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installfava(); err != nil {
...
func (pkg favaFormula) Installfava() error {
