...
// fpingFormula represents a formula in Go.
type fpingFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	...
	if err := pkg.Installfping(); err != nil {
...
func (pkg fpingFormula) Installfping() error {
