...
// fdroidclFormula represents a formula in Go.
type fdroidclFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg fdroidclFormula) Print() {
...
", dep)
    ...
    if err := pkg.Installfdroidcl(); err != nil {
...
func (pkg fdroidclFormula) Installfdroidcl() error {
