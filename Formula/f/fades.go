...
// fadesFormula represents a formula in Go.
type fadesFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installfades(); err != nil {
...
func (pkg fadesFormula) Installfades() error {
