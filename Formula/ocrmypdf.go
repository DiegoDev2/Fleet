...
func installOcrmypdf() {
	...
	exec.Command("latte", "install", "img2pdf").Run()
	fmt.Println("Instalando dependencia: jbig2enc")
	exec.Command("latte", "install", "jbig2enc").Run()
	...
	exec.Command("latte", "install", "pngquant").Run()
	...
	exec.Command("latte", "install", "qpdf").Run()
	...
	exec.Command("latte", "install", "unpaper").Run()
}
