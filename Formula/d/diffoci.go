...
// diffociFormula represents a formula in Go.
type diffociFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    pkg := diffociFormula{
        ...
        Sha256:       "d4a9db815bb968bb47a10edf9ce0b4fe5b4340807fc78ab493147e7b98a82a00",
...
", dep)
    ...
    if err := pkg.Installdiffoci(); err != nil {
...
func (pkg diffociFormula) Installdiffoci() error {
