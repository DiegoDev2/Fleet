...
// dfixFormula represents a formula in Go.
type dfixFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    pkg := dfixFormula{
        Description:  "Auto-upgrade tool for D source code",
    ...
    if err := pkg.Installdfix(); err != nil {
...
func (pkg dfixFormula) Installdfix() error {
