...
// diskusFormula represents a formula in Go.
type diskusFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installdiskus(); err != nil {
...
func (pkg diskusFormula) Installdiskus() error {
