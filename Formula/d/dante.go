...
// danteFormula represents a formula in Go.
type danteFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installdante(); err != nil {
...
func (pkg danteFormula) Installdante() error {
