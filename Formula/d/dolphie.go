...
// dolphieFormula represents a formula in Go.
type dolphieFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installdolphie(); err != nil {
...
func (pkg dolphieFormula) Installdolphie() error {
