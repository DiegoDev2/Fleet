...
// duraFormula represents a formula in Go.
type duraFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	pkg := duraFormula{
		Description:  "Backs up your work automatically via Git commits",
	...
	if err := pkg.Installdura(); err != nil {
...
func (pkg duraFormula) Installdura() error {
