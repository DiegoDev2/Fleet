...
// dos2unixFormula represents a formula in Go.
type dos2unixFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func (pkg dos2unixFormula) Print() {
...
func main() {
	...
	if err := pkg.Installdos2unix(); err != nil {
...
func (pkg dos2unixFormula) Installdos2unix() error {
