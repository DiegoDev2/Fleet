...
// dnsrobocertFormula represents a formula in Go.
type dnsrobocertFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg dnsrobocertFormula) Print() {
...
func main() {
    ...
    if err := pkg.Installdnsrobocert(); err != nil {
...
func (pkg dnsrobocertFormula) Installdnsrobocert() error {
