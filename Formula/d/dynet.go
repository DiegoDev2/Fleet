...
// dynetFormula represents a formula in Go.
type dynetFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installdynet(); err != nil {
...
func (pkg dynetFormula) Installdynet() error {
