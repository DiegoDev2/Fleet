...
// detoxFormula represents a formula in Go.
type detoxFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    pkg := detoxFormula{
        ...
        Sha256:       "cb4ab816445009b488e415ec13b576903e89a89e367bcf31313896b589163448",
...
", dep)
    ...
    if err := pkg.Installdetox(); err != nil {
...
func (pkg detoxFormula) Installdetox() error {
