...
// libloFormula represents a formula in Go.
type libloFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func (pkg libloFormula) Print() {
	fmt.Printf("Name: liblo\n")
...
func main() {
	...
	if err := pkg.Installliblo(); err != nil {
...
func (pkg libloFormula) Installliblo() error {
