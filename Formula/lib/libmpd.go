...
// libmpdFormula represents a formula in Go.
type libmpdFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func (pkg libmpdFormula) Print() {
	fmt.Printf("Name: libmpd\n")
...
func main() {
	...
	if err := pkg.Installlibmpd(); err != nil {
...
func (pkg libmpdFormula) Installlibmpd() error {
