...
// liboauthFormula represents a formula in Go.
type liboauthFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func (pkg liboauthFormula) Print() {
	fmt.Printf("Name: liboauth\n")
...
func main() {
	...
	if err := pkg.Installliboauth(); err != nil {
...
func (pkg liboauthFormula) Installliboauth() error {
