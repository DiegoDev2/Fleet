...
// xrayFormula represents a formula in Go.
type xrayFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installxray(); err != nil {
...
func (pkg xrayFormula) Installxray() error {
