...
// xurlsFormula represents a formula in Go.
type xurlsFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installxurls(); err != nil {
...
func (pkg xurlsFormula) Installxurls() error {
