...
// xsdFormula represents a formula in Go.
type xsdFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    pkg := xsdFormula{
        ...
        Dependencies: []string{"pkg-config", "xerces-c"},
    }
...
func (pkg xsdFormula) Installxsd() error {
