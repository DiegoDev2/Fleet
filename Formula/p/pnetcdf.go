...
// pnetcdfFormula represents a formula in Go.
type pnetcdfFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installpnetcdf(); err != nil {
...
func (pkg pnetcdfFormula) Installpnetcdf() error {
