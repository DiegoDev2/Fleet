...
// pip-toolsFormula represents a formula in Go.
type pip-toolsFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg pip-toolsFormula) Print() {
    fmt.Printf("Name: pip-tools\n")
...
func main() {
    ...
    if err := pkg.Installpip-tools(); err != nil {
...
func (pkg pip-toolsFormula) Installpip-tools() error {
