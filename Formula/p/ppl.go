...
// pplFormula represents a formula in Go.
type pplFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg pplFormula) Installppl() error {
