...
// pupFormula represents a formula in Go.
type pupFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg pupFormula) Installpup() error {
