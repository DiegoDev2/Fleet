...
// publishFormula represents a formula in Go.
type publishFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installpublish(); err != nil {
...
func (pkg publishFormula) Installpublish() error {
