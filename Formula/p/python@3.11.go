...
// python@3.11Formula represents a formula in Go.
type python@3.11Formula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg python@3.11Formula) Print() {
    fmt.Printf("Name: python@3.11\n")
...
func main() {
    ...
    if err := pkg.Installpython@3.11(); err != nil {
...
func (pkg python@3.11Formula) Installpython@3.11() error {
