...
// pastelFormula represents a formula in Go.
type pastelFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installpastel(); err != nil {
...
func (pkg pastelFormula) Installpastel() error {
