...
// pictFormula represents a formula in Go.
type pictFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	...
	if err := pkg.Installpict(); err != nil {
...
func (pkg pictFormula) Installpict() error {
