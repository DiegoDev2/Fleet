...
// pferdFormula represents a formula in Go.
type pferdFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installpferd(); err != nil {
...
func (pkg pferdFormula) Installpferd() error {
