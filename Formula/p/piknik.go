...
// piknikFormula represents a formula in Go.
type piknikFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installpiknik(); err != nil {
...
func (pkg piknikFormula) Installpiknik() error {
