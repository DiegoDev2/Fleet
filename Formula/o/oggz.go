...
// oggzFormula represents a formula in Go.
type oggzFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installoggz(); err != nil {
...
func (pkg oggzFormula) Installoggz() error {
