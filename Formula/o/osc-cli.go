...
// osc-cliFormula represents a formula in Go.
type osc-cliFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg osc-cliFormula) Print() {
    fmt.Printf("Name: osc-cli\n")
...
func main() {
    ...
    if err := pkg.Installosc-cli(); err != nil {
...
func (pkg osc-cliFormula) Installosc-cli() error {
