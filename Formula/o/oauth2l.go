...
// oauth2lFormula represents a formula in Go.
type oauth2lFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installoauth2l(); err != nil {
...
func (pkg oauth2lFormula) Installoauth2l() error {
