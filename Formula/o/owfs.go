...
// owfsFormula represents a formula in Go.
type owfsFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installowfs(); err != nil {
...
func (pkg owfsFormula) Installowfs() error {
