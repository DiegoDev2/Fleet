...
// jdtlsFormula represents a formula in Go.
type jdtlsFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    pkg := jdtlsFormula{
        ...
        Sha256:       "5836d754f19e15704dc14962ca4922413ca241450f99501ae846c05e1ddd4407",
    ...
    if err := pkg.Installjdtls(); err != nil {
...
func (pkg jdtlsFormula) Installjdtls() error {
