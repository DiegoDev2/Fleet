...
// jsonnetFormula represents a formula in Go.
type jsonnetFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	...
	if err := pkg.Installjsonnet(); err != nil {
...
func (pkg jsonnetFormula) Installjsonnet() error {
