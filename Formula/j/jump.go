...
// jumpFormula represents a formula in Go.
type jumpFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installjump(); err != nil {
...
func (pkg jumpFormula) Installjump() error {
