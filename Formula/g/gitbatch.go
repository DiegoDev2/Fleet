...
// gitbatchFormula represents a formula in Go.
type gitbatchFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg gitbatchFormula) Print() {
...
func main() {
    ...
    if err := pkg.Installgitbatch(); err != nil {
...
func (pkg gitbatchFormula) Installgitbatch() error {
