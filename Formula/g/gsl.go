...
// gslFormula represents a formula in Go.
type gslFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func (pkg gslFormula) Installgsl() error {
