...
// gotoFormula represents a formula in Go.
type gotoFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    pkg := gotoFormula{
        ...
        Sha256:       "43777539bca93f8ed079e3c3701cc37128ac7ba6b98006b91c39a0aa2e6b09bc",
        Dependencies: []string{},
    }
...
", dep)
    ...
    if err := pkg.Installgoto(); err != nil {
...
func (pkg gotoFormula) Installgoto() error {
