...
// ggshieldFormula represents a formula in Go.
type ggshieldFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg ggshieldFormula) Print() {
...
func main() {
    ...
    if err := pkg.Installggshield(); err != nil {
...
func (pkg ggshieldFormula) Installggshield() error {
