...
// gcalcliFormula represents a formula in Go.
type gcalcliFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installgcalcli(); err != nil {
...
func (pkg gcalcliFormula) Installgcalcli() error {
