...
// gokartFormula represents a formula in Go.
type gokartFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    pkg := gokartFormula{
        Description:  "Static code analysis for securing Go code",
    ...
    if err := pkg.Installgokart(); err != nil {
...
func (pkg gokartFormula) Installgokart() error {
