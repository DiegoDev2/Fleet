...
// ghc@9.2Formula represents a formula in Go.
type ghc@9.2Formula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg ghc@9.2Formula) Print() {
    fmt.Printf("Name: ghc@9.2\n")
...
func main() {
    pkg := ghc@9.2Formula{
        ...
        Dependencies: []string{"autoconf", "automake", "python@3.12", "sphinx-doc", "gmp"},
    }
...
", dep)
    ...
    if err := pkg.Installghc@9.2(); err != nil {
...
func (pkg ghc@9.2Formula) Installghc@9.2() error {
