...
// goremanFormula represents a formula in Go.
type goremanFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installgoreman(); err != nil {
...
func (pkg goremanFormula) Installgoreman() error {
