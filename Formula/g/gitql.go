...
// gitqlFormula represents a formula in Go.
type gitqlFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	pkg := gitqlFormula{
		Description:  "Git query language",
	...
	if err := pkg.Installgitql(); err != nil {
...
func (pkg gitqlFormula) Installgitql() error {
