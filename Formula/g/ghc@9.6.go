...
// ghc@9.6Formula represents a formula in Go.
type ghc@9.6Formula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg ghc@9.6Formula) Print() {
    fmt.Printf("Name: ghc@9.6\n")
...
func main() {
    ...
    if err := pkg.Installghc@9.6(); err != nil {
...
func (pkg ghc@9.6Formula) Installghc@9.6() error {
