...
// glowFormula represents a formula in Go.
type glowFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installglow(); err != nil {
...
func (pkg glowFormula) Installglow() error {
