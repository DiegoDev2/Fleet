...
// gostaticFormula represents a formula in Go.
type gostaticFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg gostaticFormula) Print() {
...
func main() {
    ...
    if err := pkg.Installgostatic(); err != nil {
...
func (pkg gostaticFormula) Installgostatic() error {
