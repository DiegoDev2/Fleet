...
// glpkFormula represents a formula in Go.
type glpkFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	...
	if err := pkg.Installglpk(); err != nil {
...
func (pkg glpkFormula) Installglpk() error {
