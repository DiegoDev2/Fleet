...
// PhpAT82 - General-purpose scripting language
...
func installPhpAT82() {
	...
	phpat82_tar_url := "https://www.php.net/distributions/php-8.2.23.tar.xz"
	phpat82_cmd_tar := exec.Command("curl", "-L", phpat82_tar_url, "-o", "package.tar.gz")
	err := phpat82_cmd_tar.Run()
	if err != nil {
	...
	phpat82_zip_url := "https://www.php.net/distributions/php-8.2.23.tar.xz"
	phpat82_cmd_zip := exec.Command("curl", "-L", phpat82_zip_url, "-o", "package.zip")
	err = phpat82_cmd_zip.Run()
	if err != nil {
	...
	phpat82_bin_url := "https://www.php.net/distributions/php-8.2.23.tar.xz"
	phpat82_cmd_bin := exec.Command("curl", "-L", phpat82_bin_url, "-o", "binary.bin")
	err = phpat82_cmd_bin.Run()
	if err != nil {
	...
	phpat82_src_url := "https://www.php.net/distributions/php-8.2.23.tar.xz"
	phpat82_cmd_src := exec.Command("curl", "-L", phpat82_src_url, "-o", "source.tar.gz")
	err = phpat82_cmd_src.Run()
	if err != nil {
	...
	phpat82_cmd_direct := exec.Command("./binary")
	err = phpat82_cmd_direct.Run()
	if err != nil {
