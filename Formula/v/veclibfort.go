...
// veclibfortFormula represents a formula in Go.
type veclibfortFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func (pkg veclibfortFormula) Print() {
...
", dep)
    ...
    if err := pkg.Installveclibfort(); err != nil {
...
func (pkg veclibfortFormula) Installveclibfort() error {
