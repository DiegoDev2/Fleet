...
// v2rayFormula represents a formula in Go.
type v2rayFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installv2ray(); err != nil {
...
func (pkg v2rayFormula) Installv2ray() error {
