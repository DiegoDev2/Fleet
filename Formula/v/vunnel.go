...
// vunnelFormula represents a formula in Go.
type vunnelFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installvunnel(); err != nil {
...
func (pkg vunnelFormula) Installvunnel() error {
