...
// vaultedFormula represents a formula in Go.
type vaultedFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installvaulted(); err != nil {
...
func (pkg vaultedFormula) Installvaulted() error {
