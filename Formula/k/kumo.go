...
// kumoFormula represents a formula in Go.
type kumoFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	pkg := kumoFormula{
		...
		Sha256:       "964493ca566d7dc73ab4519fa820e7360981acd9d8d343920f843b83642cc008",
	...
	if err := pkg.Installkumo(); err != nil {
...
func (pkg kumoFormula) Installkumo() error {
