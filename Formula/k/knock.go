...
// knockFormula represents a formula in Go.
type knockFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installknock(); err != nil {
...
func (pkg knockFormula) Installknock() error {
