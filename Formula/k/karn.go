...
// karnFormula represents a formula in Go.
type karnFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installkarn(); err != nil {
...
func (pkg karnFormula) Installkarn() error {
