...
// nloptFormula represents a formula in Go.
type nloptFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installnlopt(); err != nil {
...
func (pkg nloptFormula) Installnlopt() error {
