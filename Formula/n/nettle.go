...
// nettleFormula represents a formula in Go.
type nettleFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
", dep)
    ...
    if err := pkg.Installnettle(); err != nil {
...
func (pkg nettleFormula) Installnettle() error {
