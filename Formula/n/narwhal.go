...
// narwhalFormula represents a formula in Go.
type narwhalFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	...
	if err := pkg.Installnarwhal(); err != nil {
...
func (pkg narwhalFormula) Installnarwhal() error {
