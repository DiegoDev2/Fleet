...
// leveldbFormula represents a formula in Go.
type leveldbFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	pkg := leveldbFormula{
		...
		Dependencies: []string{"cmake", "gperftools", "snappy"},
	}
	...
	if err := pkg.Installleveldb(); err != nil {
...
func (pkg leveldbFormula) Installleveldb() error {
