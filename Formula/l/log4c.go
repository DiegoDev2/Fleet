...
// log4cFormula represents a formula in Go.
type log4cFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	...
	if err := pkg.Installlog4c(); err != nil {
...
func (pkg log4cFormula) Installlog4c() error {
