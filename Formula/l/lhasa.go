...
// lhasaFormula represents a formula in Go.
type lhasaFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	pkg := lhasaFormula{
		...
		Sha256:       "3d2389e91a008a7fe1bf3cf80ea0398679d6fc783208261a60459b3851b65622",
	...
	if err := pkg.Installlhasa(); err != nil {
...
func (pkg lhasaFormula) Installlhasa() error {
