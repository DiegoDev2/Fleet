...
// ecojiFormula represents a formula in Go.
type ecojiFormula struct {
	Description  string
	Homepage     string
	URL          string
	Sha256       string
...
func main() {
	...
	if err := pkg.Installecoji(); err != nil {
...
func (pkg ecojiFormula) Installecoji() error {
