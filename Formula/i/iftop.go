...
// iftopFormula represents a formula in Go.
type iftopFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installiftop(); err != nil {
...
func (pkg iftopFormula) Installiftop() error {
