...
// iredisFormula represents a formula in Go.
type iredisFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installiredis(); err != nil {
...
func (pkg iredisFormula) Installiredis() error {
