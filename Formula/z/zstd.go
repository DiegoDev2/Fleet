...
// zstdFormula represents a formula in Go.
type zstdFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    pkg := zstdFormula{
        ...
        Dependencies: []string{"cmake", "lz4", "xz"},
    }
    ...
    if err := pkg.Installzstd(); err != nil {
...
func (pkg zstdFormula) Installzstd() error {
