...
// zreplFormula represents a formula in Go.
type zreplFormula struct {
    Description  string
    Homepage     string
    URL          string
    Sha256       string
...
func main() {
    ...
    if err := pkg.Installzrepl(); err != nil {
...
func (pkg zreplFormula) Installzrepl() error {
